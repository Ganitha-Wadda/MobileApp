    ...
    >
      ...
      <Animated.View style={[styles.buttonsBlock, { transform: [{ translateY: btnTranslate }] }]}>
        {links.map((link, i) => (
          ...
          >
            <LinearGradient
              colors={i % 2 === 0 ? ["#8B5CF6", "#6D28D9"] : ["#A855F7", "#4C1D95"]}
              start={{ x: 0, y: 0 }}
              end={{ x: 1, y: 1 }}
      ...
      <SafeAreaView style={styles.safeArea}>
        ...
        >
            ...
            <View style={styles.headerLeft}>
              ...
              <View style={styles.headerTextBox}>
                ...
                <Text style={styles.headerSub}>
                  {userGrade ? `Grade ${userGrade} — your classes` : "Join your class and learn live!"}
                </Text>
              </View>
            </View>
          ...
          {!isLoading && !errorMessage && liveClasses.length === 0 && (
            <View style={styles.centerBox}>
              <Text style={styles.stateEmoji}>📡</Text>
              <Text style={styles.stateTitle}>No Live Class Right Now</Text>
              <Text style={styles.stateSub}>
                Live sessions appear here starting 3 hours before the scheduled
                time and stay visible for 10 hours after they begin.
              </Text>
            </View>
          )}
...
const styles = StyleSheet.create({
  ...
  header: {
    ...
    marginBottom: 12, zIndex: 5,
  },
  headerLeft:    { flexDirection: "row", alignItems: "center", flex: 1 },
  liveIconBg: {
    width: 46, height: 46, borderRadius: 17,
    backgroundColor: "#FFFFFF", alignItems: "center", justifyContent: "center",
    shadowColor: "#6D28D9", shadowOpacity: 0.2, shadowRadius: 10, elevation: 5,
  },
  liveBadge: {
  ...
  calendarBtn: {
    ...
    backgroundColor: "#FFFFFF", alignItems: "center", justifyContent: "center",
    shadowColor: "#6D28D9", shadowOpacity: 0.16, shadowRadius: 8,
    elevation: 4, marginLeft: 8,
  },
  ...
  liveDotWrapper: { width: 11, height: 11, alignItems: "center", justifyContent: "center", marginRight: 6 },
  liveDotRing:    { position: "absolute", width: 11, height: 11, borderRadius: 6, backgroundColor: "#FCA5A5", opacity: 0.45 },
  liveDot:        { width: 7,  height: 7,  borderRadius: 4,  backgroundColor: "#EF4444" },
  liveNowText:    { fontSize: 10.5, fontWeight: "900", color: "#6D28D9", letterSpacing: 0.7 },

  classNameRow:  { flexDirection: "row", alignItems: "center", marginBottom: 8, paddingHorizontal: 4 },
  classDecor:    { fontSize: 18, color: "#FBBF24", marginHorizontal: 7, fontWeight: "900" },
  className:     { fontSize: isVeryShortScreen ? 20 : 24, fontWeight: "900", color: "#2E1065", letterSpacing: 0.5, flexShrink: 1 },
  ...
  avatarInner: {
    ...
    borderRadius: 60, overflow: "hidden", backgroundColor: "#F5D0FE",
  },
  ...
  cameraBadge: {
    ...
    backgroundColor: "#FFFFFF", alignItems: "center", justifyContent: "center",
    shadowColor: "#6D28D9", shadowOpacity: 0.3, shadowRadius: 6, elevation: 4,
  },
  ...
  linkBtnGradient: { flexDirection: "row", alignItems: "center", borderRadius: 50, paddingVertical: 11, paddingHorizontal: 16 },
  btnIconCircle: {
  ...
  reminderStrip: {
    ...
    borderRadius: 22, paddingVertical: 12, paddingHorizontal: 12,
    marginTop: 4,
    borderWidth: 1.5, borderColor: "rgba(255,255,255,0.95)",
    shadowColor: "#6D28D9", shadowOffset: { width: 0, height: 4 },
    shadowOpacity: 0.13, shadowRadius: 8, elevation: 4, zIndex: 5,
  },
  reminderIcon: {
  ...
  gradeBadgeText: { fontSize: 11, fontWeight: "800", color: "#6D28D9", letterSpacing: 0.4 },
  ...
  centerBox: {
    ...
    borderRadius: 26, paddingVertical: 44, paddingHorizontal: 28,
    marginTop: 8,
    borderWidth: 1.5, borderColor: "rgba(255,255,255,0.95)",
  ...
  stateTitle:   { fontSize: 16, fontWeight: "900", color: "#2E1065", marginBottom: 6, textAlign: "center" },
  stateSub:     { fontSize: 12, color: "#6D28D9", textAlign: "center", lineHeight: 18, fontWeight: "600" },
  retryBtn:     { marginTop: 18, backgroundColor: "#7C3AED", borderRadius: 50, paddingHorizontal: 28, paddingVertical: 10 },
  retryBtnText: { color: "#FFFFFF", fontSize: 13, fontWeight: "900", letterSpacing: 0.3 },
});