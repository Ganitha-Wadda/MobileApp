...
const SparkDot = ({ style, delay = 0, color = '#B8F0D8' }) => {
...
export default function LessonByLesson({ navigation }) {
  ...
  return (
    <View style={styles.container}>
      <StatusBar barStyle="dark-content" backgroundColor="#E6F7EE" />

      <LinearGradient
        colors={['#E6F7EE', '#FFF8EC', '#EDF9F3']}
        style={StyleSheet.absoluteFill}
        start={{ x: 0, y: 0 }}
        end={{ x: 1, y: 1 }}
      />

      <SparkDot style={{ top: height * 0.08, left: width * 0.07 }} delay={0} color="#B8F0D8" />
      <SparkDot style={{ top: height * 0.12, right: width * 0.08 }} delay={400} color="#FFE0A8" />
      <SparkDot style={{ top: height * 0.21, left: width * 0.14 }} delay={200} color="#B8F0D8" />
      <SparkDot style={{ top: height * 0.63, left: width * 0.05 }} delay={600} color="#FFE0A8" />
      <SparkDot style={{ top: height * 0.71, right: width * 0.07 }} delay={300} color="#B8F0D8" />
      <SparkDot style={{ top: height * 0.8, left: width * 0.18 }} delay={100} color="#FFE0A8" />

      <FloatingStar style={{ top: height * 0.07, left: width * 0.05 }} size={20} color="#FFD700" delay={0} />
      <FloatingStar style={{ top: height * 0.13, right: width * 0.05 }} size={13} color="#A8E6C8" delay={300} />
      <FloatingStar style={{ top: height * 0.24, left: width * 0.04 }} size={17} color="#FFD700" delay={600} />
      <FloatingStar style={{ top: height * 0.6, left: width * 0.04 }} size={22} color="#FFD700" delay={200} />
      <FloatingStar style={{ top: height * 0.68, right: width * 0.05 }} size={15} color="#FFD700" delay={500} />
      <FloatingStar style={{ top: height * 0.75, left: width * 0.09 }} size={12} color="#A8E6C8" delay={800} />
      <FloatingStar style={{ top: height * 0.82, right: width * 0.1 }} size={18} color="#FFD700" delay={100} />
      ...
      >
        <View style={styles.bookWrapper}>
          ...
          <BadgeTile icon="🎓" bgColor="#22C55E" style={styles.tileTopLeft} delay={0} />
          <BadgeTile icon="📖" bgColor="#F97316" style={styles.tileTopRight} delay={300} />
          <BadgeTile icon="💡" bgColor="#FACC15" style={styles.tileMidRight} delay={600} />

          <FloatChar char="A" color="#16A34A" style={styles.bigCharA} delay={100} fontSize={64} />
          <FloatChar char="→" color="#F97316" style={styles.bigCharArrow} delay={400} fontSize={52} />
          <FloatChar char="Z" color="#16A34A" style={styles.bigCharZ} delay={250} fontSize={64} />
        </View>
      </Animated.View>
...
const styles = StyleSheet.create({
  ...
  bigCharA: { top: '20%', left: '12%' },
  bigCharArrow: { top: '24%', left: '37%' },
  bigCharZ: { top: '20%', right: '12%' },
  sparkDot: {
    position: 'absolute',
    width: 6,
    height: 6,
