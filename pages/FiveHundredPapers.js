    ...
    <View style={styles.container}>
      ...
      >
        <View style={styles.bookWrapper}>
          ...
          <BadgeTile icon="✏️" bgColor="#8B5CF6" style={styles.tileTopRight} delay={300} />
          <BadgeTile icon="✅" bgColor="#FACC15" style={styles.tileMidRight} delay={600} />

          <FloatChar char="5" color="#6D28D9" style={styles.bigChar5} delay={100} fontSize={62} />
          <FloatChar char="0" color="#F97316" style={styles.bigChar0a} delay={400} fontSize={62} />
          <FloatChar char="0" color="#6D28D9" style={styles.bigChar0b} delay={250} fontSize={62} />
        </View>
      </Animated.View>
      ...
      >
        <Text style={styles.titleText}>{t("fiveHundredPapersTitle")}</Text>
        <Text style={styles.subtitleText}>{t("fiveHundredPapersSubtitle")}</Text>
      </Animated.View>
